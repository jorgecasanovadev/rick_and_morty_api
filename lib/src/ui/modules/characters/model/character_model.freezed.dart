...
class _$_CharacterModel implements _CharacterModel {
  ...
  @override
  String toString() {
    return 'CharacterModel(id: $id, name: $name, status: $status, species: $species, type: $type, gender: $gender, origin: $origin, location: $location, image: $image)';
  }
...
abstract class _CharacterModel implements CharacterModel {
  const factory _CharacterModel(
      ...
      final Origin? origin,
      final Location? location,
      final String? image}) = _$_CharacterModel;
...
class _$_Origin implements _Origin {
  const _$_Origin({this.name, this.url});
...
class _$_Location implements _Location {
  const _$_Location({this.name, this.url});
